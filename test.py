...
class ThreeMeanStockModel(StockModel):
    ...
    def train(self):
        self.model_path = os.path.join(self.model_base_path, 'test')
        feature = history_features_turnover()
        train_dataset,  test_dataset= feature.get_dataset()
        print(train_dataset)
        self.features = train_dataset.iloc[:, 0: 300]
        self.labels = train_dataset.iloc[:, 300: 301]
    ...
    def evel(self):
        ...
        self.features = dataset.iloc[:, 0: 300]
        self.features = dataset.iloc[:, 300: 301]
